...
export const ErrorComp = (props)=> {
  ...
  <div style={{ width: '100%', maxWidth: '1200px', margin: 'auto', padding: '16px', display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
    ...
    <div style={{ width: '100%', maxWidth: '58.333333%', textAlign: 'center', padding: '16px' }}>
      ...
      <Link to={'/'} style={{ border: '1px solid white', fontWeight: '600', borderRadius: '0.25rem', padding: '1rem', display: 'inline-block', textDecoration: 'none', color: 'white', transition: 'background-color 0.3s, color 0.3s' }} 
